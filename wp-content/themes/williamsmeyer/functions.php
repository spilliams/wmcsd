...
function williamsmeyer_setup() {
  ...
  if ( function_exists('register_sidebar')) {
    register_sidebar(array(
      ...
      'before_widget' => '<div class="row"><div class="twelve columns">',
      'after_widget' => '</div><hr></div></div>',
      'before_title' => '<h2 style="display:inline-block;">',
      'after_title' => '</h2><div style="display:inline-block;">',
    ));
  }
